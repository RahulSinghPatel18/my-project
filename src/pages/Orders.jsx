            ...
            <div className="py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4" key={index} >
              ...
              <div className="">
                ...
                <div className="flex items-center gap-3 mt-2 text-base text-gray-500">
                  <p className='text-lg'><span className='text-green-500'>{currency}</span>{item.price}</p>
                  <p>Quantity: 1</p>
                  <p>Size : M</p>
                </div>
                <p className="mt-2">Date: <span className='text-gray-400'>12,7,2024</span></p>
              </div>
              </div>
